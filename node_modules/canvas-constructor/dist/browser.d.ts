/// <reference lib="dom" />
export declare type NativeCanvas = HTMLCanvasElement;
export declare type NativeCanvasRenderingContext2D = CanvasRenderingContext2D;
export declare type NativeImage = HTMLImageElement;
...
export declare type PatternResolvable = Canvas | CanvasImageSource;
...
export declare function loadImage(src: string, options?: Partial<HTMLImageElement>): Promise<HTMLImageElement>;
/**
