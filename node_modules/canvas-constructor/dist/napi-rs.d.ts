...
import { Canvas as NativeCanvas, GlobalFonts, Image as NativeImage, Path2D, loadImage, type AvifConfig, type SKRSContext2D as NativeCanvasRenderingContext2D } from '@napi-rs/canvas';
...
export declare type ImageResolvable = Canvas | NativeImage | NativeCanvas;
export declare type PatternResolvable = Canvas | NativeImage | ImageData;
export declare type PatternRepeat = 'repeat' | 'repeat-x' | 'repeat-y' | 'no-repeat' | null;
export declare type Transform = ReturnType<NativeCanvasRenderingContext2D['getTransform']>;
export declare type ContextAttributes = ReturnType<NativeCanvasRenderingContext2D['getContextAttributes']>;
export declare class Canvas {
     ...
     */
    constructor(width: number, height: number, contextAttributes?: ContextAttributes);
    /**
     ...
     */
    get contextAttributes(): ContextAttributes;
    /**
     ...
     */
    jpegAsync(quality?: number): Promise<Buffer>;
    /**
     * Gets a WebP buffer.
     ...
     */
    webpAsync(quality?: number): Promise<Buffer>;
    /**
     * Gets a PNG buffer.
...
export declare function loadFont(font: Buffer, alias?: string): boolean;
export declare function loadFont(path: string, alias?: string): boolean;
export declare function loadFontsFromDirectory(path: string): number;
 ...
 */
export declare type FontVariantLigatures = 'common-ligatures' | 'no-common-ligatures' | 'discretionary-ligatures' | 'no-discretionary-ligatures' | 'historical-ligatures' | 'no-historical-ligatures' | 'contextual' | 'no-contextual';
/**
 * @see https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-alternates
 */
export declare type FontVariantAlternates = 'historical-forms' | `stylistic(${string})` | `styleset(${string})` | `character-variant(${string})` | `swash(${string})` | `ornaments(${string})` | `annotation()${string}'`;
/**
 * @see https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-caps
 */
export declare type FontVariantCaps = 'small-caps' | 'all-small-caps' | 'petite-caps';
/**
 * @see https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-numeric
 */
export declare type FontVariantNumeric = 'lining-nums' | 'oldstyle-nums' | 'proportional-nums' | 'tabular-nums' | 'diagonal-fractions' | 'stacked-fractions' | 'ordinal' | 'slashed-zero';
/**
 * @see https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-east-asian
 */
export declare type FontVariantEastAsian = 'jis78' | 'jis83' | 'jis90' | 'jis04' | 'simplified' | 'traditional' | 'full-width' | 'proportional-width' | 'ruby';
export declare type FontVariantString = 'normal' | 'none' | string;
export declare type FontVariants = FontVariantLigatures | FontVariantAlternates | FontVariantCaps | FontVariantNumeric | FontVariantEastAsian;
declare type GetFontVariant<K extends FontVariants> = K extends FontVariantLigatures ? FontVariantLigatures : K extends FontVariantAlternates ? FontVariantAlternates : K extends FontVariantCaps ? FontVariantCaps : K extends FontVariantNumeric ? FontVariantNumeric : FontVariantEastAsian;
