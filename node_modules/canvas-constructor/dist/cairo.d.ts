...
import { Canvas as NativeCanvas, CanvasRenderingContext2D as NativeCanvasRenderingContext2D, Image as NativeImage, JpegConfig, JPEGStream, loadImage, PdfConfig, PDFStream, PngConfig, PNGStream, registerFont as loadFont } from 'canvas';
...
export declare type PatternResolvable = Canvas | NativeImage | NativeImage;
...
export declare type AntiAlias = NativeCanvasRenderingContext2D['antialias'];
export declare type TextDrawingMode = NativeCanvasRenderingContext2D['textDrawingMode'];
export declare type PatternQuality = NativeCanvasRenderingContext2D['patternQuality'];
